...
const translations = {
  ...
  delete_selected: { vi: 'Xóa đã chọn', en: 'Delete selected' },
  delete_all: { vi: 'Xóa tất cả', en: 'Delete all' },
  delete_selected_confirm: { vi: 'Xóa {count} cặp Q&A đã chọn?', en: 'Delete {count} selected Q&A pairs?' },
  delete_all_confirm: { vi: 'Xóa TẤT CẢ {count} cặp Q&A? Hành động này không thể hoàn tác.', en: 'Delete ALL {count} Q&A pairs? This cannot be undone.' },
  selected_count: { vi: 'Đã chọn {count}', en: '{count} selected' },
  approve: { vi: 'Duyệt', en: 'Approve' },
  approve_all: { vi: 'Duyệt tất cả', en: 'Approve all' },
  approve_selected: { vi: 'Duyệt đã chọn', en: 'Approve selected' },
  approve_confirm: { vi: 'Duyệt Q&A này? (chuyển sang ai_approved)', en: 'Approve this Q&A? (mark as ai_approved)' },
  approve_all_confirm: { vi: 'Duyệt TẤT CẢ {count} Q&A auto_scan?', en: 'Approve ALL {count} auto_scan Q&A pairs?' },
  ...
  default_url: { vi: 'Mặc định: http://localhost:3939', en: 'Default: http://localhost:3939' },
  ...
  referral_program: { vi: 'Giới thiệu nhận thưởng', en: 'Refer & Earn' },
  ...
  // ===== Flows Tab =====
  tab_flows: { vi: 'Kịch bản', en: 'Flows' },
  flows_title: { vi: 'Kịch bản thu thập thông tin', en: 'Information Collection Flows' },
  flows_desc: { vi: 'Tạo kịch bản để bot chủ động hỏi và thu thập thông tin từ khách hàng.', en: 'Create flows so the bot proactively asks and collects information from customers.' },
  add_flow: { vi: '+ Thêm kịch bản', en: '+ Add Flow' },
  no_flows_yet: { vi: 'Chưa có kịch bản nào', en: 'No flows yet' },
  no_flows_desc: { vi: 'Tạo kịch bản đầu tiên để bot tự động thu thập thông tin khách hàng.', en: 'Create your first flow to automatically collect customer information.' },
  flow_name: { vi: 'Tên kịch bản', en: 'Flow Name' },
  flow_name_placeholder: { vi: 'VD: Đặt bàn nhà hàng, Đặt lịch spa...', en: 'E.g.: Restaurant booking, Spa appointment...' },
  trigger_mode: { vi: 'Kích hoạt khi', en: 'Trigger Mode' },
  trigger_keyword: { vi: 'Khách nhắn từ khóa', en: 'Customer sends keyword' },
  trigger_first_message: { vi: 'Tin nhắn đầu tiên', en: 'First message' },
  trigger_manual: { vi: 'Thủ công', en: 'Manual' },
  trigger_keywords: { vi: 'Từ khóa kích hoạt', en: 'Trigger Keywords' },
  trigger_keywords_placeholder: { vi: 'đặt bàn, book bàn, reservation (phân cách bằng dấu phẩy)', en: 'book table, reservation, reserve (comma separated)' },
  greeting_message: { vi: 'Tin nhắn chào', en: 'Greeting Message' },
  greeting_placeholder: { vi: 'VD: Chào bạn! Để đặt bàn, mình cần một số thông tin nhé.', en: 'E.g.: Hi! To book a table, I need some information.' },
  completion_message: { vi: 'Tin nhắn hoàn thành', en: 'Completion Message' },
  completion_placeholder: { vi: 'VD: Cảm ơn {name}! Đã ghi nhận đặt bàn lúc {time} ngày {date}.', en: 'E.g.: Thank you {name}! Booking confirmed at {time} on {date}.' },
  completion_hint: { vi: 'Dùng {step_id} để chèn dữ liệu đã thu thập', en: 'Use {step_id} to insert collected data' },
  flow_steps: { vi: 'Các bước thu thập', en: 'Collection Steps' },
  add_step: { vi: '+ Thêm bước', en: '+ Add Step' },
  step_id: { vi: 'ID (khóa)', en: 'ID (key)' },
  step_label: { vi: 'Tên hiển thị', en: 'Display Name' },
  step_prompt: { vi: 'Câu hỏi gửi khách', en: 'Question to ask' },
  step_type: { vi: 'Loại', en: 'Type' },
  step_type_text: { vi: 'Văn bản', en: 'Text' },
  step_type_choice: { vi: 'Lựa chọn', en: 'Choice' },
  step_type_number: { vi: 'Số', en: 'Number' },
  step_required: { vi: 'Bắt buộc', en: 'Required' },
  step_options: { vi: 'Các lựa chọn', en: 'Options' },
  step_options_placeholder: { vi: 'VD: 2 người, 4 người, 6 người (phân cách bằng dấu phẩy)', en: 'E.g.: 2 people, 4 people, 6 people (comma separated)' },
  flow_active: { vi: 'Đang bật', en: 'Active' },
  flow_inactive: { vi: 'Tắt', en: 'Inactive' },
  flow_steps_count: { vi: 'bước', en: 'steps' },
  delete_flow_confirm: { vi: 'Xóa kịch bản này?', en: 'Delete this flow?' },
  flow_save_failed: { vi: 'Lưu kịch bản thất bại', en: 'Failed to save flow' },
  flow_need_name: { vi: 'Cần nhập tên kịch bản', en: 'Flow name is required' },
  flow_need_steps: { vi: 'Cần ít nhất 1 bước thu thập', en: 'At least 1 collection step is required' },
